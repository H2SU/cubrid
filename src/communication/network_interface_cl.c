...
/*
 * mmon_dump_memory_usage - request to server to dump memory usage info
 *                           to the file
 * return : cubrid error
 */
int
mmon_dump_memory_usage ()
{
#if defined(CS_MODE)
  char *buffer = NULL;
  char *ptr = NULL;
  ...
  req_error =
    net_client_request2 (NET_SERVER_MMON_DUMP_MEMORY_USAGE, NULL, 0, reply, OR_ALIGNED_BUF_SIZE (a_reply), NULL, 0,
			 &buffer, &bufsize);
